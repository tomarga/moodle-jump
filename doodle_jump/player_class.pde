class Player {
  ...
  public void update( ArrayList<Platform> platforms, MyFloat first_horiz_line ) {
    
    this.check_collision( platforms );
    this.move();
    this.move_world( platforms, first_horiz_line );
  ...
  public void move_world( ArrayList<Platform> platforms, MyFloat first_horiz_line ) {
    if (this.y < 300) {
